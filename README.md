...
**Merged overview** — [@subhramonyu](https://github.com/subhramonyu) **+** [@fnsventures](https://github.com/fnsventures) (contributions summed over the **last 365 days**, public repos and stars on **owned non-fork** repos summed). Generated by this repo’s **Merged GitHub stats** workflow.

<p align="center">
  <img src="merged-stats.svg" alt="Combined GitHub statistics for both profiles" width="820" />
</p>

<sub>Set repository variable **`ALT_GITHUB_USERNAME`** if your second handle isn’t `fnsventures` (Settings → Secrets and variables → Actions → Variables). Optional secret **`MERGE_STATS_TOKEN`**: fine-grained PAT with read-only access if you ever hit API limits; otherwise the default `GITHUB_TOKEN` is enough for public data.</sub>

<details>
<summary><strong>Per-account cards</strong> <em>(same metrics, not merged)</em></summary>

**[@subhramonyu](https://github.com/subhramonyu)**

<p align="center">
  <img height="165" src="https://github-readme-stats.vercel.app/api?username=subhramonyu&show_icons=true&theme=tokyonight&hide_border=true&title_color=58A6FF&icon_color=79C0FF" alt="GitHub stats — subhramonyu" />
  <img height="165" src="https://streak-stats.demolab.com/?user=subhramonyu&theme=tokyonight&hide_border=true" alt="Contribution streak — subhramonyu" />
</p>

**[@fnsventures](https://github.com/fnsventures)**

<p align="center">
  <img height="165" src="https://github-readme-stats.vercel.app/api?username=fnsventures&show_icons=true&theme=tokyonight&hide_border=true&title_color=A371F7&icon_color=C297FF" alt="GitHub stats — alt account" />
  <img height="165" src="https://streak-stats.demolab.com/?user=fnsventures&theme=radical&hide_border=true" alt="Contribution streak — alt account" />
</p>
